...
public class MonadicCalculatorMain {
    public static void main(String[] args) {
        Calculator.of(10) // inits calculator with the default value 10
                ...
                .consume(System.out::println); // doesn't not print anything
...
class Calculator<T extends Number> {
    ...
    public static <T extends Number> Calculator<T> of(T value) {
        // Implement this method // write your code here
        if (Objects.isNull(value)) return getBrokenCalculator();
